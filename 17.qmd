...
$$f(x) = \norm{Ax - b}^2 = \trans{(Ax - b)} (Ax - b) = x^T A^T A x - 2 b^T A x + b^T b$$
Calculamos la derivada (gradiente) de $f(x)$ respecto a $x$ e gualamos a cero:

$$\nabla f(x) = 2 \trans{A} A x - 2 \trans{A} b$$

$$\nabla f(x) = 0 \quad \Rightarrow \quad \trans{A} A x = \trans{A} b$$

Llegamos nuevamente a la ecuación normal de mínimos cuadrados.
