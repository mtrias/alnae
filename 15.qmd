...
El Análisis de Componentes Principales es una de las herramientas más potentes de la estadística para entender matrices de datos masivos. Su objetivo central es reducir la dimensionalidad de los datos, extrayendo la información más importante mediante la identificación de las direcciones de mayor varianza [@lecture Lec. 7; @clase15 Clase 15].
...
Para ilustrar el funcionamiento del PCA, consideramos una matriz de datos $X \in \mathbb{R}^{n \times d}$ con $d=2$ variables (por ejemplo, altura y peso) y $n$ individuos [@clase15].
