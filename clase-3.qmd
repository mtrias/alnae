...
Sea $A = [A_1, A_2, \dots, A_n] \in \mathcal{M}^{m \times n}$ una matriz donde $A_j$ representa su $j$-ésima columna, y $A_{*i}$ representa su $i$-ésima fila. Sea $x = (x_1, x_2, \dots, x_n) \in \mathbb{R}^n$ Entonces, el producto $Ax$ de la matriz $A$ por el vector $x$ es una operación fundamental, que puede interpretarse de varias maneras [@lecture Lec. 1].
