...
Dado que los vectores $v_i$ son elegidos para ser ortonormales, la matriz $V$ cumple la propiedad de las matrices de Stiefel: $V^\top V = \mathbb{I}$ [@lecture Lec. 3 '02; @alnae clase 5]. Al multiplicar por $V^\top$ a la derecha en ambos lados de la ecuación anterior, obtenemos la representación final de la SVD $A = \svd$
...
Cuando una matriz $A \in \mathbb{R}^{m \times n}$ tiene sus columnas linealmente independientes ($m \ge n$ y $\text{rank}(A) = n$), el sistema $Ax = b$ es generalmente sobredeterminado y no tiene una solución exacta [@lecture Lec. 9; @clase17 Clase 17]. En este escenario, la pseudoinversa $A^+$ surge naturalmente de la necesidad de encontrar la "mejor solución" posible.
