...
Una de las formas más poderosas de interpretar la Descomposición en Valores Singulares no es como un producto de tres matrices ($A = U\Sigma V^\top$), sino como una suma de "bloques de construcción" fundamentales representados por **matrices de rango 1** [@lecture Lec. 2; @clase11 Clase 11].
...
*   **$u_i \trans{v}_i$**: Es el bloque estructural (producto exterior de los vectores singulares izquierdo y derecho).
