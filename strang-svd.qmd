...
La acción de multiplicar por una matriz $A$ puede descomponerse en tres pasos geométricos elementales [@lectures - Lecture 3 '6]:
...
#### Determinantes
El determinante de una matriz ortogonal es siempre $1$ (o $-1$ si incluye reflexión) [@lectures - Lecture 3 '13]. Para una matriz cuadrada, el producto de los valores singulares $\prod \sigma_i$ es igual al valor absoluto del determinante.
...
Esta matriz $A_k$ es la más cercana a $A$ en términos de la norma de Frobenius y la norma inducida $\ell_2$ [@lectures - Lecture 7 '16; @strang I.7]. 

## La Pseudo-inversa ($A^+$)

La SVD proporciona una forma robusta de definir la inversa para matrices no invertibles o rectangulares [@lectures - Lecture 9 '06; @strang I.7]:
$$A^+ = V \Sigma^+ U^T$$
