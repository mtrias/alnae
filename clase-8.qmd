...
**Prueba:** Por definición de matriz de Stiefel, $Q^\top Q = \mathbb{I}$. En el caso cuadrado, una matriz que posee una inversa a izquierda también la posee a derecha y es única. Por tanto, $Q^\top = Q^{-1}$, lo que implica que también se verifica $Q Q^\top = \mathbb{I}$ [@parcial Parcial 1 Ej1a].
