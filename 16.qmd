...
Si las columnas de $A$ son linealmente independientes, entonces la matriz $A^\top A$ es invertible y la solución $\hat{x}$ es única:
...
## Solución vía SVD <span class="toc-ignore">La Pseudoinversa de Moore-Penrose</span> $A^+$
