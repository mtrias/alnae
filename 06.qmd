...
Como $v^\top v = 1$, la expresión se simplifica a $I - 4vv^\top + 4vv^\top = \identity$.\ Por lo tanto: $H^2 = \identity$.

Ortogonal
: Sabemos que es simétrica, por lo que $H^\top = H$ y sabemos que es involutiva, por lo que $H^2 = I$ entonces $H H = H^\top H = I$ por lo tanto es ortogonal, y $H^{-1} = H^\top$.
...
$$Hv=(I−2vv^\top)v=v−2v=−v$$

Autovalor $\lambda_1=1$
: El hiperplano ortogonal a $v$, denotado como $v\perp$ es el espacio propio asociado al autovalor $\lambda_1=1$. Cualquier vector $w$ contenido en este plano satisface $Hw=w$, lo que significa que el valor propio $1$ tiene una multiplicidad de $n−1$.
