...
La desigualdad de Cauchy-Schwarz es uno de los pilares fundamentales del análisis matemático y el álgebra lineal aplicada. Establece un límite superior estricto para el producto interno de dos vectores en términos del producto de sus normas [@practico Pr3 Ej2; @practico Pr5 Ej2; @lecture Lec. 4, @lecture Lec. 3, @practico Pr5 Ej2; @alnae Clase 17].
